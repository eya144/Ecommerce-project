	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789">20553239</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:maamourieya46@gmail.com" class="email__addr">support@yourwebsite.com</a>
				</div>
			</div>
